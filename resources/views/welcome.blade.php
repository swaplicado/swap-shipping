...
<head>
    ...
    <link href="{{ asset('css/Bootstrap/bootstrap-carousel.css') }}" rel="stylesheet">
</head>
       ...
       <nav class="navbar navbar-expand-md fixed-top bg_orange d-flex flex-wrap align-items-center justify-content-center justify-content-md-between mb-4">
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          ...
          <div class="col-12 col-md-auto text-end">
            <p style="color: white">Av. Industrial S/N Nave A. Colonia Las Ánimas Tepotzotlán, Estado de México. C.P. 54616</p>
          </div>
