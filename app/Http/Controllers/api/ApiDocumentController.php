...
class ApiDocumentController extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($verify->code === 200) {
            ...
            return json_encode(['code' => $verify->code, 'message' => 'Documento guardado correctamente', 'data' => json_encode($request->all())], JSON_PRETTY_PRINT);
        }
        else {
            $oLog = new MRequestLog();
            ...
            return json_encode(['code' => $verify->code, 'message' => $verify->message, 'data' => json_encode($request->all())], JSON_PRETTY_PRINT);
        }
    }
}
